...
async function about(sender_psid) {
    ...
    const arraySend = [];
    const titleList = ["KQ XH THPTQG", "Thời khóa biểu", "Câu lạc bộ", "Thông tin thầy cô", "Lịch dạy thay", "Hỗ trợ học tập"];
    const payloadList = [PostbackID.THPTQG, PostbackID.TKB, PostbackID.CLB, PostbackID.Info, PostbackID.LDT, PostbackID.HTHT];
